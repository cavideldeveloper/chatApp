<div x-data="{ optionsDrop: false }" class="flex flex-col h-full w-full bg-white px-4 py-6">
    ...
    @if ($viewId != null)
        <div class="flex flex-row items-center py-4 px-6 rounded-2xl shadow">
            ...
            <div class="ml-auto">
                ...
                <li class=" relative">
                    <a x-on:click='optionsDrop? optionsDrop = false: optionsDrop= true' href="#" class="flex items-center justify-center bg-gray-100 hover:bg-gray-200 text-gray-400 h-10 w-10 rounded-full ">
                        <span>
                            <svg class="w-5 h-5"
                                fill="none"
                                stroke="currentColor"
                        ...
                        <div @click.away='optionsDrop = false' style="display: none" x-show.transition='optionsDrop' class="w-44 h-auto bg-white absolute top-11 right-0 z-50 shadow-lg rounded-lg py-3">
                            <ul>
                                <li wire:click='clearChat' class=" px-3 py-2 text-red-500 hover:bg-gray-200 text-center">Clear Chat</li>
                            </ul>
                        </div>
                    </a>
                </li>
            ...
            <div class="flex flex-row items-center w-full border rounded-3xl h-12 px-2">
                ...
                <div class="w-full">
                <input wire:model='message' type="text" class="border border-transparent w-full focus:outline-none text-sm h-10 flex items-center" placeholder="Type your message....">
                </div>
            ...
            <div class="ml-6">
                <button wire:click="saveMessage" class="flex items-center justify-center h-10 w-10 rounded-full bg-gray-200 hover:bg-gray-300 text-indigo-800 text-white focus:outline-none">
    ...
    @else
        <div class=" text-center">
            <p class=" text-sm text-gray-600 px-4 py-1 bg-gray-300 rounded-lg inline-block mt-28"> Select a contact to start Messaging</p>
        </div>
    @endif
