<div class="flex flex-col h-full w-full bg-white px-4 py-6">
    ...
    @if ($viewId != null)
        <div class="flex flex-row items-center py-4 px-6 rounded-2xl shadow">
            ...
            <div class="flex flex-col ml-3">
                ...
                <div class="text-xs text-gray-500">{{count($group->users)}} members</div>
            </div>
            <div class="ml-auto">
            ...
            <div class="h-full overflow-hidden py-4">
                <div id="messages" class="h-full overflow-y-auto">
                        ...
                        @foreach ($messages as $message)
                            ...
                            @livewire('message', ['type'=>'group','message' => $message], key($message->id))
    ...
    @else
        <div class=" text-center">
            <p class=" text-sm text-gray-600 px-4 py-1 bg-gray-300 rounded-lg inline-block mt-28"> Select a group to start Messaging</p>
        </div>
    @endif
